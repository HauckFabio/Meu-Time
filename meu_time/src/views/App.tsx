...
function App() {
  ...
  return (
    <div className="App row" style={{ background: "#282c34" }}>
  

          <header className="App-header col-12">
            <div className="row ">
            <div className="mb-3 col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <img src='logoFutebol.png' className='w-25' /><br></br>
            <h1 className='m-4'>BEM VINDO AO MEU TIME</h1>
              <h1 className="form-label">
                INFORME SUA 'API TOKEN' PARA ACESSAR O SISTEMA
              </h1>
              <div className='row'>
              <div className='col-3'/>
              <div className='col-6'>
              <input type="password" className="form-control text-center mx-auto w-100" id="apiToken" onChange={(e) => setToken(e.target.value)} />
              </div>
              <div className='col-3'/>
              </div>
            </div>

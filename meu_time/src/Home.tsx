...
function Home() {
      ...
      const selectedObj = teams.find((val: any) => val.team.id+"" === selectedValue);
        ...
        if (selectedObj) {
          ...
          HomeService.statisticsTeam(selectedObj.team.id,selectedSeasons, selectedLeagues).then((r) => {
            ...
            console.log(r.data.response.fixtures);
  ...
  return (
    ...
    <>
        ...
        <div className='row'>
        <div className='col-xs-12 col-xs-12 col-sm-12 col-md-2 col-lg-2 col-xl-2'/>
      ...
      <div className='row'>
      <div className='col-2'/>
      <button type="button" onClick={clickReset} className="btn btn-primary mt-2 col-3 col-xs-3 col-sm-3 col-md-2 col-lg-2 col-xl-2  mb-3">
              RESETAR
        ...
        {selectedTeams !== undefined &&
        <div className='col-xs-12 mx-auto w-75'>
            <label className='col-xs-12'>INFORMAÇÕES DO CLUBE</label>
       ...
       { <Dashboard data={selectedTeamGols}/>}
        ...
        {selectedTeams !== undefined &&
         <div className='col-xs-12 mx-auto w-75 mt-2'>
           <label className='col-xs-12'>JOGADORES DO CLUBE {selectedTeamPlayers.length > 0 ? selectedTeamPlayers.length : 0}</label>
         <Datatable estilo="table table-hover table-bordered table-striped"
